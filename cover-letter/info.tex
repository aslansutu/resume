...
\newcommand{\myname}{Atakan Onol} % Your name (e.g. "John Smith")
\newcommand{\mytitle}{Applicant} % Your title (e.g. "Applicant")
\newcommand{\myemail}{atakan16@gmail.com} % Your email (e.g. "me@mydomain.com")
\newcommand{\mylinkedin}{atakan-onol-547427160} % Your LinkedIn profile name (e.g. "myname")
\newcommand{\myphone}{+1.919.888.8974} % Your phone number (e.g. "123.456.7890")
\newcommand{\mylocation}{Ankara, TR} % Your general location (e.g. "PNW, USA")
